...
import crux12june2018.BinaryTreeDemo.Node;
...
public class BinarySearchTree {
	...
	public void replaceWithSum() {
		...
		replaceWithSum(this.root,mover);
	}

	private void replaceWithSum(Node node, Mover mover) {
		
		if(node == null) {
			return;
		}
		replaceWithSum(node.right, mover);
